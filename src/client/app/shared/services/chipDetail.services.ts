...
export class ChipDetailsService {
  ...
  getChipDetailsByName(name:string):Observable<Chip[]>  {
       ...
       if(name === 'T186') {
         this.modulesUrl = 'http://localhost:3000/goldenregister/v1/chips/t186';
       }

       if(name === 'T124') {
         this.modulesUrl = 'http://localhost:3000/goldenregister/v1/chips/t124';
       }
  ...
  private chipsUrl = 'http://localhost:3000/goldenregister/v1/chips';  // URL to web API
